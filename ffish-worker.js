...
// 配置：ffish文件的基础路径（相对于网站根目录）
// 如果ffish.js和ffish.wasm在js/目录下，设置为 '/js/'
// 如果在根目录，设置为 '/'
const FFISH_BASE_PATH = self.location.pathname.substring(0, self.location.pathname.lastIndexOf('/') + 1);
